...
uint32_t getCellVoltage(int cellNumber) {
	...
	I2CReadLength = 2;
	I2CMasterBuffer[0] = 0x08;
	I2CMasterBuffer[1] = 0x0C + cellNumber;
	I2CmasterWriteRead( I2CMasterBuffer, I2CSlaveBuffer, I2CWriteLength, I2CReadLength );
	/* The temp reading value should reside in I2CSlaveBuffer... */
...
//	  }
	  ...
	  printf("Cell 1: %d", cellVoltage1);
	  printf("Cell 2: %d", cellVoltage2);
	  printf("Cell 3: %d", cellVoltage3);
	  printf("Cell 4: %d", cellVoltage4);
...
//				printf("Temperaturen er -%d grader C.\r\n", (tempReading & 0xFFFF));
//			}
//			else {
//				printf("Temperaturen er %d grader C. \r\n", tempReading);
//			}
